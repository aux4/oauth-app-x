...
```execute
aux4 oauth-app-x exchange --body '{"code":"abc","codeVerifier":"def","redirectUri":"http://127.0.0.1:9876/callback"}'
```
...
```execute
aux4 oauth-app-x exchange --params '{"provider":"github"}' --body '{"code":"abc","codeVerifier":"def","redirectUri":"http://127.0.0.1:9876/callback"}'
```
...
```execute
X_CLIENT_ID= X_CLIENT_SECRET= aux4 oauth-app-x exchange --params '{"provider":"x"}' --body '{"code":"abc","codeVerifier":"def","redirectUri":"http://127.0.0.1:9876/callback"}'
```
